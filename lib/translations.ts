...
export const translations = {
  fr: {
    ...
    saveTheDate: {
      label: "Vos Vœux",
      title1: "Nous serons honorés",
      title2: "& bénis par vos vœux",
      date: "2 Mai 2026",
    ...
    rsvp: {
      title: "Vos Vœux",
      subtitle: "Votre affection nous touche profondément. Laissez-nous un message bienveillant, une prière ou un vœu qui éclairera notre chemin. 💍",
  ...
  en: {
    ...
    saveTheDate: {
      label: "Your Wishes",
      title1: "We will be honored",
      title2: "& blessed by your wishes",
      date: "May 2, 2026",
    ...
    rsvp: {
      title: "Your Wishes",
      subtitle: "Your affection touches us deeply. Leave us a kind message, a prayer, or a wish that will light our path. 💍",
  ...
  de: {
    ...
    saveTheDate: {
      label: "Ihre Wünsche",
      title1: "Wir wären geehrt",
      title2: "& gesegnet durch Ihre Wünsche",
      date: "2. Mai 2026",
    ...
    rsvp: {
      title: "Ihre Wünsche",
      subtitle: "Ihre Zuneigung berührt uns zutiefst. Hinterlassen Sie uns eine freundliche Nachricht, ein Gebet oder einen Wunsch, der unser Weg erhellen wird. 💍",
